...
public class BadgeRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        if (status.equals("ACTIVO") || status.equals("COMPLETADO") || status.equals("COMPLETADA") || status.equals("EN STOCK")) {
        ...
        } else if (status.equals("CANCELADA") || status.equals("AGOTADO") || status.equals("INACTIVO") || status.equals("STOCK BAJO") || status.equals("SIN STOCK")) {
